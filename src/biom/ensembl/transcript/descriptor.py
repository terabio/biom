...
from ..common import EnsemblDescriptor
...
class Record:
    ...
    gencode_basic: str | None = None
    ensembl_canonical: bool | None = None
    # Coordinates
...
class Descriptor(EnsemblDescriptor):
    def __init__(self, attributes: set[Attribute], cache: Path):
        ...
        mapping = {
            Attribute.Name: "name", Attribute.Gene: "gene", Attribute.Biotype: "biotype", Attribute.Source: "source",
            Attribute.SupportLevel: "support_level", Attribute.MANESelect: "mane_select",
            Attribute.MANEPlusClinical: "mane_plus_clinical", Attribute.GENCODEbasic: "gencode_basic",
            Attribute.EnsemblCanonical: "ensembl_canonical",
